...
class SessionController extends Controller{
    ...
    function validateSession(){
        ...
        if($this->existsSession()){
            ...
            error_log("sessionController::validateSession(): username:" . $this->user->getNombrePersona() . " - role: " . $this->user->getRol());
            if($this->isPublic()){
    ...
    function existsSession(){
        if(!$this->session->exits()) return false;
    ...
    function getUserSessionData(){
        ...
        $this->user->get($id);
        error_log("sessionController::getUserSessionData(): " . $this->user->getNombrePersona());
        return $this->user;
    }
    ...
    private function redirectDefaultSiteByRole($role){
        ...
        for($i = 0; $i < sizeof($this->sites); $i++){
            if($this->sites[$i]['role'] === $role){
                $url = 'https://mascotasssssssssssss.000webhostapp.com/'.$this->sites[$i]['site'];
            break;
            }
        }
        header('location: '.$url);
